                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MegaByte Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MBC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mbc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MegaByte Core"), this);
    aboutAction->setStatusTip(tr("Show information about MegaByte Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MBC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MBC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MBC addresses"));
    ...
    openAction->setStatusTip(tr("Open a mbc: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MegaByte Core help message to get a list with possible MBC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MegaByte Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MBC network", "", count));
}
...
{
    QString strTitle = tr("MegaByte Core"); // default title
