...
---------------
algorithm: quark
pszTimestamp: Mr.IT-Architect+AlexSashkA=MegaByteCoin.eu.org|28.02.2026|07:00
pubkey: 04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f
bits: 504365040
time: 1772240400
merkle root hash: 82caa113e91e9e121a33196a981e9749f30c6a68ce230016c22bf244139f6769
Searching for genesis hash...
nonce: 1851249
genesis hash: 000002de39703cc989665c802e3eb867c5cb3b846b9c221f7893c7c37577d522
*/
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey                   = ParseHex("02c8eea9d8a4e49322a5bb460676e3ef70f83db3626f868051250007abc34db5c3");
        nDefaultPort                   = 18777;
        ...
        nTargetSpacing                 =  1 * 60;  // MBC: 1 minute blocks during POW (block 1-200)

        bnProofOfStakeLimit            = ~uint256(0) >> 20;
        nTargetTimespanPOS             = 40 * 60; 
        nTargetSpacingPOS              =  1 * 60;  // MBC: 1 minute blocks during POS
...
---------------
algorithm: quark
pzTimestamp: Mr.IT-Architect + AlexSashkA = MegaByteCoin.eu.org 27.02.2026
pubkey: 04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f
bits: 504365040
time: 1566556888
merkle root hash: 62d47ac93ec42b08797fe92ab94251f16f107d84f109376a5fa17a5115edfb59
Searching for genesis hash...
nonce: 907591
genesis hash: 000007e9ec0c5c95498bd2de0f05dcabeb694663fe3c14f1d32fcb9b033d6022
*/
        const char* pszTimestamp       = "Mr.IT-Architect+AlexSashkA=MegaByteCoin.eu.org|28.02.2026|07:00";
        ...
        genesis.nVersion               = 1;
        // Генезис обновлён под перезапуск сети «с нуля» (сложность оставлена как была).
        genesis.nTime                  = 1772240400; // 28.02.2026 01:00 UTC
        genesis.nBits                  = 504365040;  // compact difficulty (оставлено как было)
        genesis.nNonce                 = 1851249;    // найден подбором для указанного pszTimestamp/nTime/nBits

        hashGenesisBlock               = genesis.GetHash();
        assert(hashGenesisBlock        == uint256("0x000002de39703cc989665c802e3eb867c5cb3b846b9c221f7893c7c37577d522"));
        assert(genesis.hashMerkleRoot  == uint256("0x82caa113e91e9e121a33196a981e9749f30c6a68ce230016c22bf244139f6769"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,  50);  // P2PKH-адреса начинаютcя на 'M'
        ...
        strSporkKey                    = "02c8eea9d8a4e49322a5bb460676e3ef70f83db3626f868051250007abc34db5c3";
        strMasternodePoolDummyAddress  = "CZsBLLfz7S3G2CkSN9oqhDvAvYDRND76Xj";
        nStartMasternodePayments       = 1772240400; // 28.02.2026 01:00 UTC (дата запуска сети)
...
public:
    CTestNetParams()
    {
        ...
        bnProofOfWorkLimit             = ~uint256(0) >> 20;
        nTargetTimespan                =  1 * 60; 
        nTargetSpacing                 =  1 * 60;  // MBC: 1 minute blocks during POW (block 1-200) on testnet

        bnProofOfStakeLimit            = ~uint256(0) >> 20;
        nTargetTimespanPOS             =  40 * 60; 
        nTargetSpacingPOS              =   1 * 60;  // MBC: 1 minute blocks during POS on testnet
        ...
        //! Testnet genesis aligned with mainnet (so GUI запуск без assert, если случайно включён -testnet).
        genesis.nTime                  = 1772240400;
        genesis.nNonce                 = 1851249;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // MBC: 1 day
        nTargetSpacing = 2 * 60;        // MBC: 1 minutes
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 14034;
        // assert(hashGenesisBlock        == uint256("0x000007e9ec0c5c95498bd2de0f05dcabeb694663fe3c14f1d32fcb9b033d6022"));
